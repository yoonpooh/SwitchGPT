...
[v0.2.8 をダウンロード](https://github.com/yoonpooh/SwitchGPT/releases/tag/v0.2.8) · [最新リリース](https://github.com/yoonpooh/SwitchGPT/releases/latest)

## 0.2.8 の主な変更

- **デスクトップログインの表示を修正:** 保存済みアカウントと異なるログイン方法（例: Apple でサインイン）でデスクトップにログインしていても同じアカウントとして認識し、「現在のログインアカウント」の代わりにアカウント名とプロフィール写真を表示します。
...
1. [リリースページ](https://github.com/yoonpooh/SwitchGPT/releases/tag/v0.2.8)から `SwitchGPT-v0.2.8-macos-arm64.zip` と `SHA256SUMS.txt` をダウンロードします。
...
スクリプトはビルドを実行する Mac のアーキテクチャ向けにビルドします。公開済みの v0.2.8 は Apple シリコン向けです。
