...
[下载 v0.2.6](https://github.com/yoonpooh/SwitchGPT/releases/tag/v0.2.6) · [最新版本](https://github.com/yoonpooh/SwitchGPT/releases/latest)

## 0.2.6 的主要更新

- **移除 JEV：** 删除模型及推理级别的自动选择、TypeSafe 分类和相关设置。
...
1. 从[发布页面](https://github.com/yoonpooh/SwitchGPT/releases/tag/v0.2.6)下载 `SwitchGPT-v0.2.6-macos-arm64.zip` 和 `SHA256SUMS.txt`。
...
脚本会为运行构建的 Mac 的架构生成应用。已发布的 v0.2.6 文件是 Apple 芯片构建。
