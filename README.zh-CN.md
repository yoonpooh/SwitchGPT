...
[下载 v0.2.7](https://github.com/yoonpooh/SwitchGPT/releases/tag/v0.2.7) · [最新版本](https://github.com/yoonpooh/SwitchGPT/releases/latest)

## 0.2.7 的主要更新

- **保留 Codex 模型选择：** 移除已不再需要的 GPT-5.4 mini → GPT-6 Luna 兼容路由。模型和推理级别现在会原样转发。
- **更小的发布包：** 移除仅供该路由使用的 zstd 解码器和内置库。
...
1. 从[发布页面](https://github.com/yoonpooh/SwitchGPT/releases/tag/v0.2.7)下载 `SwitchGPT-v0.2.7-macos-arm64.zip` 和 `SHA256SUMS.txt`。
...
脚本会为运行构建的 Mac 的架构生成应用。已发布的 v0.2.7 文件是 Apple 芯片构建。
