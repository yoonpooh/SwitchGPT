...
`⋯` 메뉴에서 Jev API 키를 저장한 뒤 **모델 자동 선택**을 켤 수 있습니다. 기본값은 꺼짐이며, 기존 **계정 자동 전환**과 별도로 동작합니다. 키는 macOS 키체인에 저장됩니다.
...
평가 방법과 결과는 [분류 검증](docs/jev-router-evaluation-2026-09-20.md), [모델 실행 비교](docs/jev-router-execution-evaluation-2026-09-20.md), [effort 최적화와 저장소 작업 검증](docs/jev-router-optimization-2026-09-20.md)을 참고하세요.
