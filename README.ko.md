...
1. [릴리스](https://github.com/yoonpooh/SwitchGPT/releases)에서 `SwitchGPT-v0.1.6-macos-arm64.zip`을 다운로드합니다.
...
스크립트는 빌드하는 Mac의 아키텍처를 대상으로 합니다. 공개된 v0.1.6 파일은 Apple silicon 빌드입니다.
